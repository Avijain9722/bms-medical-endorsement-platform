...
target whatever the app itself would connect to.
"""
...
from bms.models import Base  # noqa: E402
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        # table instead, which keeps one migration script valid on both engines.
